...
const ToolsSection = () => {
  return <section id="tools" className="bg-[#141414] py-0">
      <div className="section-padding">
        ...
        <div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-4 max-w-6xl mx-auto">
          ...
          return <div key={index} className="bg-card border border-border p-6 rounded-lg flex flex-col items-center text-center transition-all hover:border-teal/50 hover:-translate-y-1">
